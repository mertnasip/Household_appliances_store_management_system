...
public class Techniker extends Personal {
    ...
    public Techniker(String id, String personalId, String passwort, String name, String nachname, String filiale , String gaburtsdatum, String geschlecht, String adress, String tel_nr){
        this.id=id;
        this.personalId = personalId;
        this.passwort = passwort;
        this.name=name;
