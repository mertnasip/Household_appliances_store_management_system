...
public class Admin  extends Personal {
    ...
    public boolean addProdukt(String id, String titel, String name, Double preis, String filiale, String farbe) {
    	String query = "INSERT INTO produkt" + "(produktId,produktTitel,produktName,preis,garantiezeit,filiale,farbe,verkauf) VALUES" + "(?,?,?,?,?,?,?,'0')";
    	boolean ret = false; 
    	try {
    		con = dbm.getConnection();
	    	ps = con.prepareStatement(query);
    ...
    public boolean deleteProdukt(String id) {
    	String query = "DELETE FROM produkt WHERE produktId = ?";
    	boolean ret = false; 
    	try {
    		con = dbm.getConnection();
	    	ps = con.prepareStatement(query);
    ...
    public boolean updateProdukt(String id, String titel, String name, String preis, String garantiezeit, String filiale , String farbe) {
    	String query = "UPDATE produkt SET produktTitel = ?, produktName = ?, preis = ?, garantiezeit = ?, filiale = ?, farbe = ? WHERE produktId = ?";
    	boolean ret = false; 
    	try {
    		con = dbm.getConnection();
    	    ps = con.prepareStatement(query);
    	    ...
    	    ps.setString(2, name);
    	    ps.setDouble(3, Double.parseDouble(preis));
    	    ps.setString(4, garantiezeit);
    	    ps.setString(5, filiale);
    	    ps.setString(6, farbe);
    	    ps.setString(7, id);
    	    ps.executeUpdate();
    	    ret = true;
        } catch (SQLException e) {
