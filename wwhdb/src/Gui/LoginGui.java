...
public class LoginGui extends JFrame {
	...
	public LoginGui() {
		...
		JButton btnAdminLogin = new JButton("Anmelden");
					...
					try {
						...
						while(rs.next()) {
							if(adminPid.getText().equals(rs.getString("personalId")) && adminPasswort.getText().equals(rs.getString("passwort"))) {
								Entities.Admin admin = new Entities.Admin(rs.getString("id"),rs.getString("personalId"),rs.getString("passwort"),rs.getString("name"),rs.getString("nachname"),rs.getString("filiale"),rs.getString("geburtsdatum"),rs.getString("geschlecht"),rs.getString("adress"),rs.getString("telnr"));
					...
					try {
						...
						while(rs.next()) {
							if(verkaeuferPid.getText().equals(rs.getString("personalId")) && verkaeuferPasswort.getText().equals(rs.getString("passwort"))) {
								Entities.Verkaeufer verkaeufer = new Entities.Verkaeufer(rs.getString("id"),rs.getString("personalId"),rs.getString("passwort"),rs.getString("name"),rs.getString("nachname"),rs.getString("filiale"),rs.getString("geburtsdatum"),rs.getString("geschlecht"),rs.getString("adress"),rs.getString("telnr"));
								VerkaeuferGui verkaeuferGui = new VerkaeuferGui(verkaeufer);
								verkaeuferGui.setVisible(true);
								dispose();
								cont = true;
		...
		JButton btnNewButton_2 = new JButton("Anmelden");
					...
					try {
						...
						while(rs.next()) {
							if(technikerPid.getText().equals(rs.getString("personalId")) && technikerPasswort.getText().equals(rs.getString("passwort"))) {
								Entities.Techniker techniker = new Entities.Techniker(rs.getString("id"),rs.getString("personalId"),rs.getString("passwort"),rs.getString("name"),rs.getString("nachname"),rs.getString("filiale"),rs.getString("geburtsdatum"),rs.getString("geschlecht"),rs.getString("adress"),rs.getString("telnr"));
								TechnikerGui technikerGui = new TechnikerGui(techniker);
								technikerGui.setVisible(true);
								dispose();
								cont = true;
